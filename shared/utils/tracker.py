...
def track_video(
    ...
    """
    # ORIGINAL v5 path: Ultralytics' built-in streaming. Tracker state is
    # maintained internally. To support start_seconds we let YOLO process the
    # early frames but skip yielding them. This costs CPU on the skipped
    # portion but is the exact algorithm that produced the historical
    # -6.3% / 7,432 24hr result.
